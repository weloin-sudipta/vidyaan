...
import StopWatch from "~/components/dashboard/student/StopWatch.vue";
import AcademicCalendar from "~/components/dashboard/student/AcademicCalendar.vue";
import PaymentHistory from "~/components/dashboard/student/PaymentHistory.vue";
import Attendance from "~/components/dashboard/student/Attendance.vue";
import BookRecommendetion from "~/components/dashboard/student/BookRecommendation.vue";
import CampusNotice from "~/components/dashboard/student/CampusNotice.vue";
import Event from "~/components/dashboard/student/Event.vue";
